# Release notes — compliance-aiops 0.4.0
...
client lists **14 tools instead of 18**. The writes are not hidden
...
2 tool(s) documented as writes were carrying `risk_level="low"`:
`generate_evidence_bundle`, `export_bundle`.
...
- **`skills/compliance-aiops/references/agent-guardrails.md`** — for driving this tool with a

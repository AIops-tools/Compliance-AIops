"""compliance-aiops — governed compliance-evidence operations for AI agents.
...
``compliance_aiops.governance`` — this package has no external skill-family
...
try:
    __version__ = version("compliance-aiops")
